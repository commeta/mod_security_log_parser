...
1. Отредактируйте конфигурацию тюрьмы:
   ...
   Откройте конфигурационный файл тюрьмы Fail2Ban. Вы можете либо отредактировать основной конфигурационный файл, либо создать отдельный локальный конфигурационный файл:
