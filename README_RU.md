...
## Описание скрипта modsec_recedive.sh - блокировка DDoS атак
![htop](htop.png)
### Описание:
...
- LOG Analizer - получает данные из базы данных и отправляет информацию в iptables.
- iptables - получает данные от анализатора логов и базы данных для настройки правил фильтрации.
- Web server - конечная точкоа для обработки запросов.
...
Это обеспечивает хорошую производительность для часто используемых файлов, как в случае с файловой "базой данных" в вашем скрипте.

### Методы защиты от атак с использованием данных из логов ModSecurity 2.9
